...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/yacs-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4428&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/yacs-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `yacs` can be installed with:

```
conda install yacs
```

It is possible to list all of the versions of `yacs` available on your platform with:
